...
const Welcome = () => {
  ...
  // ✅ Helper: fire custom event so Navbar opens its LoginModal overlay
  // This replaces ALL previous navigate('/login') calls AND the old
  // showLogin / showRegister local modal system in this file.
    ...
    <div className="welcome-page">
        ...
        <div className="hero-content-modern">
          ...
          <div className="hero-trust-badges">
            <div className="trust-badge-item">
              <svg className="trust-badge-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <section className="property-types-elegant">
        <div className="elegant-container">
          ...
          <div className="elegant-properties-grid">
            {/* Residential */}
            <div className="elegant-property-card" onClick={() => handlePropertyTypeClick('residential')}>
              <div className="elegant-property-image">
                <img src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800" alt="Residential Property" />
            ...
            {/* Commercial */}
            <div className="elegant-property-card" onClick={() => handlePropertyTypeClick('commercial')}>
              <div className="elegant-property-image">
                <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800" alt="Commercial Property" />
                <div className="elegant-image-overlay"></div>
            ...
            {/* Land & Plots */}
            <div className="elegant-property-card" onClick={() => handlePropertyTypeClick('land')}>
              <div className="elegant-property-image">
                <img src="https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800" alt="Land Property" />
                <div className="elegant-image-overlay"></div>
            ...
            {/* Luxury Villas */}
            <div className="elegant-property-card" onClick={() => handlePropertyTypeClick('luxury')}>
              <div className="elegant-property-image">
                <img src="https://images.unsplash.com/photo-1613977257363-707ba9348227?w=800" alt="Luxury Villa" />
                <div className="elegant-image-overlay"></div>
      ...
      <section className="market-insights-modern">
        <div className="insights-wrapper-modern">
          ...
          {/* CTA Button */}
          <button className="insights-cta-modern" onClick={handleExplorePageClick}>
          ...
          <div className="feature-split-content">
            ...
            <div className="feature-split-images">
              <div className="feature-image-wrapper">
                <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=600" alt="Modern Property" />
              </div>
              <div className="feature-image-wrapper">
                <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600" alt="Luxury Home" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="testimonials-header">
            ...
            <div className="testimonials-stats">
              <div className="client-avatars">
                <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100" alt="Client" className="client-avatar" />
                <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100" alt="Client" className="client-avatar" />
                <img src="https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=100" alt="Client" className="client-avatar" />
                <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100" alt="Client" className="client-avatar" />
              </div>
      ...
      {/* ✅ NO modal JSX here anymore — Navbar.jsx handles ALL auth modals globally */}
    </div>
  );
};
