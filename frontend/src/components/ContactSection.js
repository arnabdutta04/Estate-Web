    ...
    <section className="contact-section-modern">
      ...
      <div className="contact-container-modern">
        ...
        <div className="contact-form-side">
          ...
          {/* Jet Form Builder Badge */}
          <div className="jetform-badge">
            <div className="jetform-icon">
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                <rect width="40" height="40" rx="8" fill="#4F7EFF"/>
                <path d="M15 12L25 20L15 28V12Z" fill="white"/>
              </svg>
            </div>
            <div className="jetform-text">
              <span className="jetform-name">jet</span>
              <span className="jetform-type">formbuilder</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <button className="contact-settings-icon">
